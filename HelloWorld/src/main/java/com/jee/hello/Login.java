...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		if ("".equals(username)) erreur += "Le champ username est vide.<br/>";
		if (!email.contains("@")) erreur += "L'email doit contenir un @.<br/>";
		if (password.length() < 3 ) erreur += "Il faut un mot de passe plus long, 3 min.<br/>";	
		if (!password.equals(confirme)) erreur += "Le mot de passe ne correspond pas au champ de confirmation.<br/>";
